# Contributing to pkg-camx-kodiak
...
1. [Fork](https://github.com/qualcomm-linux/pkg-camx-kodiak/fork) and clone the repository.

    ```bash
    git clone https://github.com/qualcomm-linux/pkg-camx-kodiak.git
    ```

1. Create a new branch based on `qcom/debian/latest`:

    ```bash
    git checkout -b <my-branch-name> qcom/debian/latest
    ```

1. Create an upstream `remote` to make it easier to keep your branches up-to-date:

    ```bash
    git remote add upstream https://github.com/qualcomm-linux/pkg-camx-kodiak.git
    ```
...
1. After committing your changes on the topic branch, sync it with the upstream branch:
    ...
    ```bash
    git pull --rebase upstream qcom/debian/latest
    ```
...
1. [Submit a pull request](https://github.com/qualcomm-linux/pkg-camx-kodiak/pulls) from your branch to `main`.
